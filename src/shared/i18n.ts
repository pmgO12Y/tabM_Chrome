...
const messages = {
  "zh-CN": {
    ...
    "options.hoveredTabPreview.hint": "悬浮标签时，在顶部显示网页标题和 URL。默认开启。",
  ...
  en: {
    ...
    "options.hoveredTabPreview.hint": "When hovering a tab, show the page title and URL at the top. Enabled by default.",
